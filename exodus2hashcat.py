...
pyperclip.copy("EXODUS:"+str(n)+":"+str(r)+":"+str(p)+":"+base64.b64encode(salt).decode("utf8")+":"+base64.b64encode(iv).decode("utf8")+":"+base64.b64encode(key).decode("utf8")+":"+base64.b64encode(authTag).decode("utf8"))
    
root = Tk()
root.withdraw()
messagebox.showinfo("Хеш скопирован", "Ваш хеш скопирован в буфер обмена")
